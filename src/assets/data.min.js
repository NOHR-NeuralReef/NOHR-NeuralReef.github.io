window.data = {
  ...
  NavBar: {
    name: 'Neural Reef',
    image: 'assets/images/neural-reef-logo.png',
    links: ['home', 'about', 'modules', 'articles', 'contact'],
  },
  About: {
    NavTabs: [
    ...
    name: 'Neural Reef',
    about:
      'The NeuralReef Vision: Reimagining AI as a Personal Companion. ' +
      '\n\n' +
    ...
    vision: [
      {
        title: 'Vision',
        description:
          'To revolutionize ease of high-end security and privacy when connecting with the digital world',
      },
      {
        title: 'Mission',
        description:
          'Empowering individuals with safe sovereign AI technology, to be productive and automate daily tasks',
      },
      {
        title: 'Innovation',
        description:
          'Pushing boundaries in AI, cryptography, on edge system and for distributed system compute',
      },
      {
        title: 'Security',
        description:
          'Provide everyone with highest-level of security and privacy, without any intervention or actions needed',
      },
    ],
    progresss: [
      [
        {
          name: 'Mycilium',
          value: 100,
          description: 'Neural Reef Core Framework',
        },
        { name: 'Coral', value: 85, description: 'Plugin System Architecture' },
        {
          name: 'Sense',
          value: 80,
          description: 'Contextual and Conceptual Embeddings',
        },
        {
          name: 'Aegis',
          value: 75,
          description: 'Post-Quantum Security Suite',
        },
      ],
      [
        {
        ...
        },
        {
          name: 'Harmony',
          value: 80,
          description: 'Maintaince and Metrics Suite',
        },
        {
          name: 'Divine',
          value: 85,
      ...
      [
        { name: 'Habitat', value: 50, description: 'Smart Home Control' },
        {
          name: 'Sphere',
          value: 20,
          description: 'Presence and Interaction Bubble',
        },
      ...
      [
        {
          name: 'Silkroad',
          value: 20,
          description: 'Distributed Gateway for inference',
        },
        { name: 'Saga', value: 80, description: 'AI-Pedia' },
        {
          name: 'Reef',
          value: 5,
          description: 'Blockchain for AI, distributed storage',
        },
  ...
  modules: [
    {
      title: 'Mycilium',
      description:
        'Foundational framework for secure AI operations and data storage',
    ...
    },
    {
      title: 'Habitat',
      description:
        'A system that connect AI and ML, analysis and automation with smarthome systems.',
    ...
    },
    {
      title: 'Silkroad',
      description:
        'Be in control of your own Data while connecting to the world',
  ...
  Quote: [
    {
      quote:
        'The future of AI is personal, private, and secure. Your data, your control.',
      author: 'Johann Kroeger',
    },
    {
      quote:
        'In the dance of bits and privacy, we are not just building a product, but choreographing a revolution of interaction with digital systems.',
      author: 'Johann Kroeger',
    },
  ],
  ...
  Articles: [
    {
      ...
      date: '2024',
      description:
        'The security measures that are advertised as safe are nearly all broken, and sold to the public as safe.',
    ...
    },
    {
      ...
      date: '2024',
      description:
        'Future-proof security with post-quantum cryptographic methods',
    ...
    },
    {
      ...
      date: '2024',
      description:
        'The privacy of your data is at risk, and the LLMs are not the solution.',
  ...
  contact: {
    cards: [
      ...
      {
        title: 'Donate/Invest',
        description: 'Help us accelerate NeuralReef, become one of the first to test our new framework and join our channels',
      },
    ],
  },
  Home: {
    typedElement: [
      "Neural Reef - Your Personal AI Guardian",
      "Privacy First, No Compromises",
      "Edge Computing, Limitless Potential",
      "Your AI, Your Control",
    ],
    introduction: [
      "Military-grade security protecting your digital life",
      "Zero-knowledge systems ensure absolute privacy",
      "Local processing with global capabilities",
      "Complete control over your AI's development",
    ],
    descriptions: [
      "Post-quantum encryption and biometric authentication",
      "Your data never leaves your personal network",
      "Neural networks that evolve without cloud dependency",
      "AI that learns and adapts to your preferences only",
    ]
  },
}
